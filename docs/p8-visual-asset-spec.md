...
## 10. P8 第三轮 carrier 正式资产试点

Carrier 复用 scout/striker 已签核的加载、manifest、回退和 QA 契约，但独立建立长纵深、航母级体量、双侧机库和分层指挥塔。外部模型替换主舰体、指挥脊、舰首/舰尾甲板、双侧机库、舱门、发射眉、外轨和功能面；指挥甲板/塔、桥灯、传感器、着舰引导、阵营条、registry、损伤、三组推进器、选择环和远景路径继续由运行时负责。

- 正式模型使用 10 个语义网格、252 个三角面，原始尺寸为宽 19.68、高 5.45、长 25.15；长度必须大于 24、宽度大于 18，并保持长度大于宽度的 1.2 倍。
- 512×512 base color 使用长条飞行甲板、纵向加强筋和机库维护带的低频大尺度表面；roughness 由底色确定性灰度派生，运行时 UV repeat 为 1×1。
- `public/assets/ships/carrier/v1/asset-manifest.json` 记录来源、权利说明、尺寸、模型/贴图哈希、33/42 近景网格预算、远景批次和程序化回退。
